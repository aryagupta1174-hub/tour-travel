...
<body class="sb-nav-fixed">
    ...
    <?php include_once("Shared/customerpagetop.php") ?>

    <div id="layoutSidenav">
        <?php include_once("Shared/customersidenav.php") ?>
        ...
        <div id="layoutSidenav_content">
            <main>                
               ...
               <h3 class="text-danger font-weight-bold" style="padding-top:20px;text-shadow: 1px 1px 1px black;">
                  ...
                  <img src="images/admin.jpg" width="200px" class="img-fluid img-thumbnail mt-5" />
 ...
 <br/><br/><br/><br/><br/><br/>
            ...
            <?php include_once("Shared/customerbottom.php") ?>
        </div>
    </div>
