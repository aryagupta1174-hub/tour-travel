...
<div class="login-form-container">
    ...
    <form action="Login.php" method="POST">
        <h3>login</h3>
        <input type="name" class="box" name="userName" placeholder="enter username">
        ...
        <p>don't have and account? <a href="registerform.php">register now</a></p>
    </form>
...
<section class="footer">
    ...
    <h1 class="credit"> created by <span><a href="#">Neha Sharma</a></span> | all rights reserved! </h1>
